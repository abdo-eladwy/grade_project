...
export default function Section15() {
  return (
    <div className="col-12 bg-dark  text-light d-flex justify-content-center align-content-center pt-5    p-lg-5">
      <div className="container col-12 d-flex flex-wrap justify-content-between allcontnt">
        ...
        <div className="col-12 col-lg-5 ">
          <span className="text-danger d-block d-lg-inline mt-5 ">Brief History</span>
