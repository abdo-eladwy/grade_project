...
import "./CorporateFraud.css";
import "bootstrap/dist/css/bootstrap.min.css";
import "bootstrap/dist/js/bootstrap";
import { useTranslation } from "react-i18next";
import img from "./custody-battle-800x550 (1).jpg";
import img1 from "./practice-item-9-800x550.jpg";
            ...
            <div className="col-12 mb-5">
              <div className="OurVision col-12 position-relative">
                ...
                <div className="overlay-text">
                  <h1 className="d-flex">{t("carouselp57")}</h1>
                </div>
              </div>
            </div>
              ...
              <div className="row gap-4 p-4">
                ...
                <div className="col-12 col-lg-8 mb-5">
                  ...
                  <div className="paragraph col-12 pb-2">
                    <p className="pb-4">{t("carouselp97")}</p>
                    <p className="pb-3">{t("carouselp98")}</p>
                    <p className="pb-3">{t("carouselp99")}</p>
                  </div>
