...
import "./InjuryLitigation.css";
import { useTranslation } from "react-i18next";
import "bootstrap/dist/css/bootstrap.min.css";
import "bootstrap/dist/js/bootstrap";
// import { useTranslation } from "react-i18next";
import img from "./custody-battle-800x550 (1).jpg";
import img1 from "./practice-item-5-800x550.jpg";
...
export default function InjuryLitigation() {
              ...
              <div className="row gap-4 p-4">
                ...
                <div className="col-12 col-lg-8 mb-5 ">
                  ...
                  <div className="paragraph col-12 pb-2">
                    <p className="pb-3">{t("carouselp90")}</p>
                    <p className="pb-4">{t("carouselp88")}</p>
                    <p className="pb-3">{t("carouselp89")}</p>
                  </div>
