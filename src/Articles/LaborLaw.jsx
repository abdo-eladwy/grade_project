...
import img1 from "./practice-item-7-800x550.jpg";
              ...
              <div className="row gap-4 p-4">
                ...
                <div className="col-12 col-lg-8 mb-5">
                  ...
                  <div className="paragraph col-12 pb-2">
                    <p className="pb-4">{t("carouselp91")}</p>
                    <p className="pb-3">{t("carouselp92")}</p>
                    <p className="pb-3">{t("carouselp93")}</p>
                  </div>
