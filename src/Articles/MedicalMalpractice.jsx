          ...
          <div className="row gap-4 p-4">
            ...
            <div className="col-12 col-lg-8 mb-5">
              ...
              <div className="paragraph col-12 pb-2">
                <p className="pb-4">{t("carouselp76")}</p>
                <p className="pb-3">{t("carouselp77")}</p>
                <p className="pb-3">{t("carouselp78")}</p>
              </div>
