...
export interface ApiServiceRequestServiceRequest
  ...
  attributes: {
    checkbox_text: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_checkbox: Schema.Attribute.Boolean & Schema.Attribute.Required;
    user_email: Schema.Attribute.Email & Schema.Attribute.Required;
    user_name: Schema.Attribute.String & Schema.Attribute.Required;
    user_phone: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
